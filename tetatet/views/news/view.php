        ...
        <div class="row">
          <div class="col-md-9 post-content" data-aos="fade-up">
            ...
            <div class="single-post">
              <div class="post-meta"><span class="date"><?=$model['category'] ?></span> <span class="mx-1">&bullet;</span> <span><?=$model['datetime']?></span></div>
              <h1 class="mb-5"><?=$model['title']?></h1>

              <div class="">
                <img src="/files/news/<?=$model['photo'] ?>_b.jpg" class="img-fluid">
              </div>
              ...
              <? if($model['user_id'] == $user['id'] || $user['role'] == 1):?>
                <div class="d-flex align-items-center author">
                  ...
                  <a href="/news/edit?id=<?=$model['id'] ?>" class="me-1 p-1"><button type="button" class="btn btn-primary"><p class="m-1">Редагувати</p></button></a>
